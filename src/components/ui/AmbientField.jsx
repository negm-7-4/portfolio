...
const SHAPES = [
  {
    Comp: Gyro,
    props: { size: 220, dur: 60, color: "rgba(150,170,210,0.16)" },
    x: "8%",
    y: "16%",
    depth: 0.9,
  },
  {
    Comp: WireCube,
    props: { size: 120, dur: 46, color: "rgba(150,170,210,0.14)" },
    x: "82%",
    y: "22%",
    depth: 0.6,
  },
  {
    Comp: Diamond,
    props: { size: 90, dur: 38, color: "rgba(150,170,210,0.16)" },
    x: "70%",
    y: "70%",
    depth: 1.0,
  },
  {
    Comp: WireCube,
    props: { size: 80, dur: 52, color: "rgba(150,170,210,0.10)" },
    x: "16%",
    y: "74%",
    depth: 0.4,
  },
  {
    Comp: Gyro,
    props: { size: 150, dur: 70, color: "rgba(150,170,210,0.10)" },
    x: "92%",
    y: "54%",
    depth: 0.5,
  },

...
export const resume = {
  ...
  contact: [
    {
      label: "Email",
      value: "mohammednegm11234@gmail.com",
      href: "mailto:mohammednegm11234@gmail.com",
    },
    ...
    {
      label: "LinkedIn",
      value: "linkedin.com/in/mohammed-negm-a45624335",
      href: "https://www.linkedin.com/in/mohammed-negm-a45624335/",
    },
    {
      label: "Portfolio",
      value: "mohamed-negm.vercel.app",
...
// Categorised toolkit — used by the big Skills layout. Curated to the tools
// actually reached for day to day; aspirational long-tail libraries were cut
// so the wall reads as real, focused expertise (not a padded list).
...
// `image` is the primary shot (used by the classic WebGL gallery); `images`
// is the full set — every other showcase crossfades through them.
export const projects = [
  ...
  {
    title: "Nexora ERP",
    category: "AI-Powered ERP · SaaS",
    tagline: "The ERP You Can Talk To",
  ...
  },
  {
    ...
    github: "https://github.com/negm-7-4/Acoustic-Room-Mapper",
    live: null,
    image: "/projects/acoustic-1.jpg",
    images: ["/projects/acoustic-1.jpg"],
